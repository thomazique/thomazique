...
<div>
  <h3>Sobre mim:</h3>
  • 👨🏻‍💻 Sou apaixonado por tecnologia e programação desde a adolescência.<br>
  • 📚 Atualmente estudo Engenharia da Computação e me dedico ao desenvolvimento web e backend.<br>
  • 🚀 Tenho experiência com HTML, CSS, JavaScript (Node.js e TypeScript), PHP e Python para engenharia de dados.<br>
  • 📈 Também possuo conhecimentos em bancos de dados como MongoDB e MySQL, além de metodologias ágeis (Scrum e Kanban).<br>
  • 🎯 Meu objetivo é contribuir com soluções inovadoras e impactantes no mercado de tecnologia.
</div>
